  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full h-full overflow-hidden relative outline-none active:cursor-grabbing lg:block hidden" // Ascundem canvas-ul pe mobile
      />

      {/* Adăugăm un container alternativ pentru mobile */}
      <div className="lg:hidden block w-full h-full overflow-y-auto">
        {/* Conținut alternativ pentru mobile */}
        <div className="p-4">
      ...
      {activeItem && (
        <>
          ...
          <h2 className={`... lg:block hidden`}>{activeItem.title}</h2>

          {/* Description - Visible only on desktop */}
          <p className={`... lg:block hidden`}>{activeItem.description}</p>

          {/* Button rămâne vizibil peste tot */}
